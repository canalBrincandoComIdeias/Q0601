...
Servo servo;
PushButton BotaoT(pinBT);
PushButton Botao1(pinB1);
PushButton Botao2(pinB2);
PushButton Botao3(pinB3);
...
void loop() {
  BotaoT.button_loop(); Botao1.button_loop(); Botao2.button_loop(); Botao3.button_loop(); // LEITURA DOS BOTÕES
